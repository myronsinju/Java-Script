...
//This funciton parses the selectedSquares array to search for win conditions.
...
function checkWinConditions()   {
    ...
    // O 0, 1, 2 condition.
     ...
     // O 3, 4, 5 condition.
    else if (arrayIncludes('O3', 'O4', 'O5'))   { drawWinLine(50, 304, 558, 304); }
    // O 6, 7, 8 condition.
    ...
    //and 9 squares are selected, the code executess.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2)    {
    ...
    const canvas = document.getElementsById('win-lines');
